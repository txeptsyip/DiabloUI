  ...
  function db:GetOrbDefaults()
	...
	--health
	  ["HEALTH"] = {
		--filling
		filling = {
		  texture = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling11",
		  grid = false,
		  color = { r = 0.95, g = 0, b = 0, },
		  colorAuto = true,--automatic coloring based on class/powertype
		  alpha = 1,
		  pos = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x =-350, y = 0 },
		},
		--textureframe
		textureframe = {
		  size = 120,
	...
	--power
	  ["POWER"] = {
		--filling
		filling = {
		  texture = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling11_fh",
		  grid = false,
		  color = { r = 0, g = 0.4, b = 1, },
		  colorAuto = true,--automatic coloring based on class/powertype
		  alpha = 1,
...
--default template
  function db:GetTemplateDefaults()
	return {
	  ["Pearl_health"] = {
		--filling
		filling = {
		  texture = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling4",
		  grid = false,
		  color = { r = 0.95, g = 0, b = 0, },
		  colorAuto = true,--automatic coloring based on class/powertype
		  alpha = 1,
	...
	["Pearl_power"] = {
		--filling
		filling = {
		  texture = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling4_fh",
		  grid = false,
		  color = { r = 0, g = 0.4, b = 1, },
		  colorAuto = true,--automatic coloring based on class/powertype
		  alpha = 1,
	  ...
	  ["D2_health"] = {
		--filling
		filling = {
		  texture = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling1",
		  grid = false,
		  color = { r = 0.95, g = 0, b = 0, },
		  colorAuto = true,--automatic coloring based on class/powertype
		  alpha = 1,
	...
	--power
	  ["D2_power"] = {
		--filling
		filling = {
		  texture = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling1_fh",
		  grid = false,
		  color = { r = 0, g = 0.4, b = 1, },
		  colorAuto = true,--automatic coloring based on class/powertype
		  alpha = 1,
  ...
  function db:GetTemplateListDefaults()
	return {
	  { value = "Pearl_health", key = "Pearl_health", notCheckable = true, keepShownOnClick = false, },
	  { value = "Pearl_power", key = "Pearl_power", notCheckable = true, keepShownOnClick = false, },
	  { value = "D2_health", key = "D2_health", notCheckable = true, keepShownOnClick = false, },
	  { value = "D2_power", key = "D2_power", notCheckable = true, keepShownOnClick = false, },
	  { value = "Grid_health", key = "Grid_health", notCheckable = true, keepShownOnClick = false, },
	  { value = "Grid_power", key = "Grid_power", notCheckable = true, keepShownOnClick = false, },
	}
  end
...
--db script on variables loaded
  db:SetScript("OnEvent", function(self, event)
	if Diablo_DB_GLOB and Diablo_DB_GLOB.reset then
	  Diablo_DB_GLOB.reset = nil
	  Diablo_DB_GLOB = db:GetTemplateDefaults()
	  Diablo_DB_GLOB.TEMPLATE = db:GetTemplateListDefaults()
	end
	--load global data
	self.loadGlobalData()
	--load character data
	if not Diablo_DB_CHAR then
...
--load character data defaults
  db.loadCharacterDataDefaults = function(type)
	...
	if type then
	  if type == "HEALTH" then
		Diablo_DB_CHAR[type] = data[type]
		print(AddonName..": health orb reseted to default")
	  elseif type == "POWER" then
		Diablo_DB_CHAR[type] = data[type]
		print(AddonName..": power orb reseted to default")
	  end
	  Diablo_DB_CHAR.scale = 1
	else
	  Diablo_DB_CHAR = data
	  print(AddonName..": character data reset to default")
	end
	db.char = Diablo_DB_CHAR
	--update the orb view
...
--load global data defaults
  db.loadGlobalDataDefaults = function()
	print(AddonName..": global data defaults loaded")
	Diablo_DB_GLOB = db:GetTemplateDefaults()
	Diablo_DB_GLOB.TEMPLATE = db:GetTemplateListDefaults()
	db.glob = Diablo_DB_GLOB
	db.list.template = Diablo_DB_GLOB.TEMPLATE
  end

--load global data
  db.loadGlobalData = function()
	Diablo_DB_GLOB = Diablo_DB_GLOB or db:GetTemplateDefaults()
	Diablo_DB_GLOB.TEMPLATE = Diablo_DB_GLOB.TEMPLATE or db:GetTemplateListDefaults()
	db.glob = Diablo_DB_GLOB
	db.list.template = Diablo_DB_GLOB.TEMPLATE
  end
...
--type: orb type
  db.loadTemplate = function(name, type)
	if not Diablo_DB_GLOB or not name then return end
	if not Diablo_DB_GLOB[name] then
	  print(AddonName..": template |c003399FF"..name.."|r not found")
	  return
	end
	db:CopyTable(Diablo_DB_GLOB[name], Diablo_DB_CHAR[type])
	print(AddonName..": template |c003399FF"..name.."|r loaded into "..strlower(type).." orb")
	--update the orb view
	ns.panel.updateOrbView()
  end
...
--type: orb type
  db.saveTemplate = function(name, type)
	...
	--create default entry first
	  local data = db:GetOrbDefaults()
	  Diablo_DB_GLOB[name] = data["HEALTH"]
	end
	db:CopyTable(db.char[type], Diablo_DB_GLOB[name])
	--adding the template name to the key-value pair list
	local nameFound = false
	for i, v in ipairs(Diablo_DB_GLOB.TEMPLATE) do
	  if v.key == name then
		nameFound = true
		break
	  end
	...
	if not nameFound then
	  tinsert(Diablo_DB_GLOB.TEMPLATE, { key = name, value = name, notCheckable = true, keepShownOnClick = false, })
	end
	print(AddonName..": "..strlower(type).." orb data saved as template |c003399FF"..name.."|r")
...
--name: template name
  db.deleteTemplate = function(name)
	...
	Diablo_DB_GLOB[name] = nil
	print(AddonName..": template |c003399FF"..name.."|r deleted")
	...
	if indexFound then
	  tremove(Diablo_DB_GLOB.TEMPLATE, indexFound)
	end
	--update the panel view
	ns.panel.updatePanelView()
  end
...
--filling texture list for dropdown
  db.list.filling_texture = {
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling1", key = "diablo3", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling2", key = "exile", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling3", key = "dominion", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling4", key = "fubble", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling5", key = "moon", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling6", key = "fraktal circle", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling7", key = "earth", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling8", key = "galaxy", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling9", key = "mars", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling10", key = "gradient", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling11", key = "moire", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling12", key = "woodpepples", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling13", key = "golf", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling14", key = "darkstar", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling15", key = "darkdiablo3", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling16", key = "stars", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling17", key = "silver", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling18", key = "nihility", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling19", key = "magnetize", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling20", key = "runes", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling21", key = "sigil orb", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_transparent", key = "transparent", },
}
  db.getListFillingTexture = function() return db.list.filling_texture end


  db.list.filling_texture_fh = {
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling1_fh", key = "diablo3", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling2_fh", key = "exile", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling3_fh", key = "dominion", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling4_fh", key = "fubble", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling5_fh", key = "moon", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling6_fh", key = "fraktal circle", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling7_fh", key = "earth", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling8_fh", key = "galaxy", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling9_fh", key = "mars", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling10_fh", key = "gradient", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling11_fh", key = "moire", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling12_fh", key = "woodpepples", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling13_fh", key = "golf", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling14_fh", key = "darkstar", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling15_fh", key = "darkdiablo3", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling16_fh", key = "stars", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling17_fh", key = "silver", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling18_fh", key = "nihility", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling19_fh", key = "magnetize", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling20_fh", key = "runes", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_filling21_fh", key = "sigil orb", },
	{ value = "Interface\\AddOns\\"..AddonName.."\\media\\orb_transparent_fh", key = "transparent", },
}
  db.getListFillingTexture_fh = function() return db.list.filling_texture_fh end
