...
--hp value
  oUF.Tags.Methods["diablo:hpval"] = function(unit)
	...
	elseif not UnitIsConnected(unit) then
	  ...
	  hpval = ns.numFormat(UnitHealth(unit) or 0).."/"..oUF.Tags.Methods["maxshp"](unit)
	end
...
--power value
  oUF.Tags.Methods["diablo:ppval"] = function(unit)
	local ppval = ns.numFormat(UnitPower(unit) or 0).."/"..oUF.Tags.Methods["maxspp"](unit)
	return ppval or ""
  end
...
--cmaxshp-curhp/maxhp short
  oUF.Tags.Methods["cmaxshp"] = function(unit)
	local cur = oUF.Tags.Methods["curhp"](unit)
	local max = oUF.Tags.Methods["maxhp"](unit)
	local val = ns.numFormat(cur).."/"..ns.numFormat(max)
	return val or ""
  end
