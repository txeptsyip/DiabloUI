local _,ns = ...
local C = LibStub("AceAddon-3.0"):NewAddon("CombatIndicator", "AceEvent-3.0", "AceHook-3.0")
MAX_INDICATOR_COUNT = 6;
COMBAT_INDICATOR_WARNING_RATE = 0.25;
local CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 = 1;
local config = {}
...
Event:SetScript("OnEvent", function(...)
    ...
    if DToolsDB.cbi == false then return end


    config = { spell = 1, leaveCombat = 1, comboPoint = 1, status = 1 };
...
local function displaySpellText(CombatIndicator_c9bd86bc8bc59457d49315cf5b8c5b88)
    local CombatIndicator_390231f67fc064f33775aafff8fa9629 = getglobal("CombatIndicator"..CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28);
    local CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9 =getglobal(CombatIndicator_390231f67fc064f33775aafff8fa9629:GetName().."Text");
    CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetText(CombatIndicator_c9bd86bc8bc59457d49315cf5b8c5b88);
    CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextHeight(24);
    CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextColor(0.0, 1.0, 1.0);
    local CombatIndicator_04c0600c1b894c6808bccb7243e44859 = BigFoot_CreateAnim("indicator" .. CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28,CombatIndicator_390231f67fc064f33775aafff8fa9629);
    local CombatIndicator_58be92ecedd8702806a7ba2af475d890 = -GetScreenWidth() / 2 - 100;
    local CombatIndicator_29bb5db232a69a0ef4ed0090c9a61caf = GetScreenHeight() / 2;
    BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SHOW", 0, nil, nil, CombatIndicator_58be92ecedd8702806a7ba2af475d890, CombatIndicator_29bb5db232a69a0ef4ed0090c9a61caf, 0.5);
    BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SLIDE", 0.1, nil, nil, 7, 7, 0);
    BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SHOCK", 0.2, nil, nil, 2, 2);
    BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "WAIT", 0.3, nil, nil);
    BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SLIDE", 2.0, nil, nil, 0, 0, -0.05);
    BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "HIDE", 0, nil, nil);
    BigFoot_PlayAnim(CombatIndicator_04c0600c1b894c6808bccb7243e44859);
    CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 = CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 + 1;
    if (CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 > MAX_INDICATOR_COUNT) then
        CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 = 1;
    end
end
local function displayComboText(CombatIndicator_3f50417fb16be9b1078eb68d24fa9c26)
    local CombatIndicator_390231f67fc064f33775aafff8fa9629 = getglobal("CombatIndicator"..CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28);
    local CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9 = getglobal(CombatIndicator_390231f67fc064f33775aafff8fa9629:GetName().."Text");
    local CombatIndicator_c9bd86bc8bc59457d49315cf5b8c5b88 = string.format(COMBAT_INDICATOR_COMBO_TEXT, CombatIndicator_3f50417fb16be9b1078eb68d24fa9c26);
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetText(CombatIndicator_c9bd86bc8bc59457d49315cf5b8c5b88);
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextHeight(36);
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextColor(1.0, 1.0, 0.0);
        local CombatIndicator_04c0600c1b894c6808bccb7243e44859 =BigFoot_CreateAnim("indicator" .. CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28, CombatIndicator_390231f67fc064f33775aafff8fa9629);
        local CombatIndicator_58be92ecedd8702806a7ba2af475d890 = -GetScreenWidth() / 2 + 100;
        local CombatIndicator_29bb5db232a69a0ef4ed0090c9a61caf = GetScreenHeight() / 2;
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SHOW", 0, nil, nil, CombatIndicator_58be92ecedd8702806a7ba2af475d890, CombatIndicator_29bb5db232a69a0ef4ed0090c9a61caf, 0.7);
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SLIDE", 0.1, nil, nil, 7, 0, 0);
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SHOCK", 0.2, nil, nil, 2, 2);
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "WAIT", 0.3, nil, nil);
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "HIDE", 0, nil, nil);
        BigFoot_PlayAnim(CombatIndicator_04c0600c1b894c6808bccb7243e44859);
...
local function displayStatusText(CombatIndicator_c9bd86bc8bc59457d49315cf5b8c5b88,CombatIndicator_b368619f792f6db16858073f805f281f,CombatIndicator_b48c6d810781a0aaca7a1daf572bf0a2,CombatIndicator_7c039e42ccbb52e606d662dd4d7eb281,CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30)
    local CombatIndicator_390231f67fc064f33775aafff8fa9629 = getglobal("CombatIndicator" ..CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28);
    local CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9 =
        getglobal(CombatIndicator_390231f67fc064f33775aafff8fa9629:GetName() .. "Text");
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetText(CombatIndicator_c9bd86bc8bc59457d49315cf5b8c5b88);
    ...
    local health = UnitHealth("player"); local maxHealth = UnitHealthMax("player");
    if (CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30) then
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextColor(CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30.CombatIndicator_3ae1f2c4b38d5f7c356b4cdb7c6e4027,CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30.CombatIndicator_0f402d7ba502a47a51c410aee99b1ff1,CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30.CombatIndicator_a0a053cacf1c8c43346fdc3adb684cb7);
    elseif (health < maxHealth * COMBAT_INDICATOR_WARNING_RATE) then
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextColor(1.0, 0.0, 0.0);
    elseif (CombatIndicator_7c039e42ccbb52e606d662dd4d7eb281) then
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextColor(0.0, 1.0, 0.0);
    elseif (CombatIndicator_b48c6d810781a0aaca7a1daf572bf0a2) then
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextColor(1.0, 0.5, 0.0);
    else
        CombatIndicator_cea1f4c93c74cba28822aecdd3d268e9:SetTextColor(1.0, 0.0, 0.0);
    end
    local CombatIndicator_04c0600c1b894c6808bccb7243e44859 = BigFoot_CreateAnim("indicator" .. CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28, CombatIndicator_390231f67fc064f33775aafff8fa9629);
        ...
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SHOCK", 0.2, nil, nil, 2, 2);
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "WAIT", 0.3, nil, nil);
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "SLIDE", 2.0, nil, nil, -7, -7, -0.05);
        BigFoot_AddAction(CombatIndicator_04c0600c1b894c6808bccb7243e44859, nil, "HIDE", 0, nil, nil);
        BigFoot_PlayAnim(CombatIndicator_04c0600c1b894c6808bccb7243e44859);
        CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 = CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 + 1;
        if (CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 > MAX_INDICATOR_COUNT)
        then
            CombatIndicator_ca0d0d660e1912c635e4a2af6bc9ff28 = 1;
        end
end
local function onUnitCombat(CombatIndicator_d0708241b607c9a9dd1953c812fadfb7,CombatIndicator_8b227d0350467199526e8c4b146b1dfe,CombatIndicator_c57af74df632aac2c797a7c202a55a5b,CombatIndicator_6d5e7d83d8358745ae4dcf61d16bd1f3)
    ...
    if (CombatIndicator_d0708241b607c9a9dd1953c812fadfb7 == "IMMUNE") then
        CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = CombatIndicator_e2d7067abe33e0db8f1c61af136fd97f["IMMUNE"];
        CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30 = CombatIndicator_7c8f6a474919abae380f8a2b0f3eca0d["IMMUNE"];
    elseif (CombatIndicator_d0708241b607c9a9dd1953c812fadfb7 == "WOUND") then
        if (CombatIndicator_8b227d0350467199526e8c4b146b1dfe == "ABSORB") then
            CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = CombatIndicator_e2d7067abe33e0db8f1c61af136fd97f["ABSORB"];
            CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30 = CombatIndicator_7c8f6a474919abae380f8a2b0f3eca0d["ABSORB"];
        elseif (CombatIndicator_c57af74df632aac2c797a7c202a55a5b ~= 0) then
            if (CombatIndicator_8b227d0350467199526e8c4b146b1dfe == "CRITICAL" or CombatIndicator_8b227d0350467199526e8c4b146b1dfe == "GLANCING" or CombatIndicator_8b227d0350467199526e8c4b146b1dfe == "CRUSHING") then
            ...
            CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = "-" .. CombatIndicator_c57af74df632aac2c797a7c202a55a5b;
        else
            CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = CombatIndicator_e2d7067abe33e0db8f1c61af136fd97f["MISS"];
            CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30 = CombatIndicator_7c8f6a474919abae380f8a2b0f3eca0d["MISS"];
        end
    elseif (CombatIndicator_d0708241b607c9a9dd1953c812fadfb7 == "BLOCK") then
        CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = CombatIndicator_e2d7067abe33e0db8f1c61af136fd97f["BLOCK"];
        CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30 = CombatIndicator_7c8f6a474919abae380f8a2b0f3eca0d["BLOCK"];
    elseif (CombatIndicator_d0708241b607c9a9dd1953c812fadfb7 == "HEAL") then
        ...
        CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = CombatIndicator_e2d7067abe33e0db8f1c61af136fd97f[CombatIndicator_d0708241b607c9a9dd1953c812fadfb7];
        CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30 = CombatIndicator_7c8f6a474919abae380f8a2b0f3eca0d[CombatIndicator_d0708241b607c9a9dd1953c812fadfb7];
            if (not CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117) then
            CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = "";
        end
    end
    displayStatusText(CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117, CombatIndicator_b368619f792f6db16858073f805f281f, CombatIndicator_b48c6d810781a0aaca7a1daf572bf0a2, CombatIndicator_7c039e42ccbb52e606d662dd4d7eb281,CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30);
end
local function onSpellMiss(self, CombatIndicator_d0708241b607c9a9dd1953c812fadfb7, ...)
    if (self and self:GetName() ~= "PlayerFrame") then return end
    local CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 = CombatIndicator_0e0825a98a765bb3b49eec7512df8f66[CombatIndicator_d0708241b607c9a9dd1953c812fadfb7];
    local CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30 = CombatIndicator_87f223aeb7df6d02f21d55ba551413a9[CombatIndicator_d0708241b607c9a9dd1953c812fadfb7];
        if (CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117 == nil) then return end
    displayStatusText(CombatIndicator_e6955c64cf39bdb23dc86de1a9ec2117, nil, nil, nil,CombatIndicator_e0e85008d0859db6bb769f09cf1b7b30);
end
function C:COMBAT_LOG_EVENT_UNFILTERED(...)
    ...
    local timestamp, event, hideCaster, sourceGUID, sourceName, sourceFlags, sourceFlags2, destGUID, destName, destFlags, destFlags2, auraId, auraName = CombatLogGetCurrentEventInfo();
        ...
        if sourceFlags and not CombatLog_Object_IsA(sourceFlags, COMBATLOG_OBJECT_NONE) then
            fromEnemy = CombatLog_Object_IsA(sourceFlags, COMBATLOG_FILTER_HOSTILE_UNITS)
        end
        if fromEnemy and UnitGUID("target") == sourceGUID and UnitIsUnit("targettarget", "player") then
            displaySpellText(CombatIndicator_fc5eab31006a7701948f217806bc9f5c:format(sourceName, auraName))
        end
    end
end
...
function C:CHAT_MSG_MONSTER_EMOTE(...)
    ...
    local _, CombatIndicator_0e2babf2e3097eec96cf9280d1412ab5, CombatIndicator_00ae4bc475ffbcf97f789256a2e707de = ...
    local CombatIndicator_34ebd5a15904b9caf228566ff45e7556 = {};
    local CombatIndicator_6e4d0db7491d6883f86de390d20dbe5b, CombatIndicator_a2f3972c23a0aa3bd7fb0e9823d918f2;
    CombatIndicator_6e4d0db7491d6883f86de390d20dbe5b, CombatIndicator_a2f3972c23a0aa3bd7fb0e9823d918f2, CombatIndicator_34ebd5a15904b9caf228566ff45e7556[0], CombatIndicator_34ebd5a15904b9caf228566ff45e7556[1], CombatIndicator_34ebd5a15904b9caf228566ff45e7556[2], CombatIndicator_34ebd5a15904b9caf228566ff45e7556[3], CombatIndicator_34ebd5a15904b9caf228566ff45e7556[4] = string.find(CombatIndicator_0e2babf2e3097eec96cf9280d1412ab5,CombatIndicator_b79481ac170934000821d225b3f051f1.CombatIndicator_a8858383576d7634cceceaf04a2ddb29);
    if (CombatIndicator_6e4d0db7491d6883f86de390d20dbe5b) then
        displaySpellText(CombatIndicator_00ae4bc475ffbcf97f789256a2e707de ..CombatIndicator_b79481ac170934000821d225b3f051f1.CombatIndicator_9241e39fd6a722e645ec9f43ea6cb401);
    end
end

function C:UNIT_COMBAT(...)
    if not config.status then return end
    local _, unit, CombatIndicator_00ae4bc475ffbcf97f789256a2e707de, CombatIndicator_6599f8c6a1b53d0212dfbab04e14e329, CombatIndicator_18bd17b74c56bfd23801044c9c9e8d4e, CombatIndicator_a29776f66159eb25625ce8ff4969048f = ...
    if (unit == "player") then
        onUnitCombat(CombatIndicator_00ae4bc475ffbcf97f789256a2e707de,CombatIndicator_6599f8c6a1b53d0212dfbab04e14e329, CombatIndicator_18bd17b74c56bfd23801044c9c9e8d4e,CombatIndicator_a29776f66159eb25625ce8ff4969048f);
    end
end
...
function CombatIndicator_Enable(flag) if flag then C:Enable() else C:Disable() end end

function CombatIndicator_EnableStatus(flag) config.status = flag end
...
function CombatIndicator_EnableShowCombo(flag) config.comboPoint = flag end
